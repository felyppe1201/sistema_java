...
public class Participacao {
    ...
    public Participacao() {}
    public Participacao(int id, int idFormulario, int idTurma, int idUsuario, Timestamp dataResposta) { this.id = id; this.idFormulario = idFormulario; this.idTurma = idTurma; this.idUsuario = idUsuario; this.dataResposta = dataResposta; }
    ...
    public Timestamp getDataResposta() { return dataResposta; } public void setDataResposta(Timestamp dataResposta) { this.dataResposta = dataResposta; }
}
