...
public class Resposta {
    ...
    public Resposta() {}
    public Resposta(int id, int idSubmissao, int idQuestao, Integer idOpcao, String texto) { this.id = id; this.idSubmissao = idSubmissao; this.idQuestao = idQuestao; this.idOpcao = idOpcao; this.texto = texto; }
    public int getId() { return id; } public void setId(int id) { this.id = id; }
    public int getIdSubmissao() { return idSubmissao; } public void setIdSubmissao(int idSubmissao) { this.idSubmissao = idSubmissao; }
