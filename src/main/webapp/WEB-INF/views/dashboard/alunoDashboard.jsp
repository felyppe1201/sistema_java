    ...
    <body>
        ...
        <main class="dashboard-content no-select">
            ...
            <section class="turmas-section">
                <!-- Nova div para alinhar título e botão (presume o CSS necessário) -->
                <div class="turmas-header"> 
                    <h2>Minhas Turmas</h2>
                    
                    <!-- NOVO BOTÃO DE REDIRECIONAMENTO PARA MATRÍCULA -->
                    <a href="${pageContext.request.contextPath}/turma-matricula" class="btn-matricula">
